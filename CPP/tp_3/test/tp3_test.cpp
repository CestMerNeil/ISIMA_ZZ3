...
TEST_CASE("TP3_Chaine::ConversionVariadic")
{
    ...
    try
    {
        std::cout << "n,i,d = " << chaine(n, i, d) << std::endl;
    }
    catch (const ExceptionChaine &e)
    {
        erreur = 1;
    ...
    REQUIRE((chaine(n, i, d) == "Smith 10 13.270000" || chaine(n, i, d) == "Smith 10 13.270000 ") == true);

    REQUIRE(erreur == 0);

    try
    {
        std::cout << "n,i,d,j = " << chaine(n, i, d, j) << std::endl;
    }
